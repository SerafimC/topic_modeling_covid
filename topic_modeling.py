...
lda = LatentDirichletAllocation(n_components=30 , learning_method='online', doc_topic_prior=0.0000001, topic_word_prior=0.000001, learning_offset=50. ,random_state=0, batch_size=1000 ).fit(tf)
print('Done!')
